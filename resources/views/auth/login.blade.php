...
<title>Lumina Lex - Iniciar Sesión</title>
...
<input class="h-4 w-4 bg-surface-container-high border-outline-variant text-primary focus:ring-primary focus:ring-offset-background rounded-full" id="remember-me" name="remember-me" type="checkbox">
...
<button class="w-full bg-transparent border border-outline-variant hover:border-on-surface text-on-surface font-body-md py-3 transition-all duration-300 flex justify-center items-center gap-3 rounded-full" type="button">
